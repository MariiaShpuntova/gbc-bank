...
var completeTransaction = function() {
  ...
  //not sure if that is right, cause they all 3 showing up
  //document.getElementById('history').innerHTML += `<li>You deposited $100.</li>`;
  //document.getElementById('history').innerHTML += `<li>You deposited $150.</li>`;
  ...
  // 3. IF the balance is less than 0, make the balance red, else make it black
       ...
       //A)//Also I used this web-site//(https://www.w3schools.com/js/js_if_else.asp)
       //I did use this web-site but it did not work out, probably I made a mistake somewhere)//(https://stackoverflow.com/questions/25713190/change-div-colour-with-js-if-else-conditiond)
        //document.getElementById("balance").style.backgroundColor = 'red';
        //}
        //else(udata >0 udata.value <70)
        //document.getElementById("balance").style.backgroundColor = 'black';
        //{
